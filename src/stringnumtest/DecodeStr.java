 ...
 * 编码规则�?: k[encoded_string]，表示其中方括号内部�? encoded_string 正好重复 k 次�?�注�? k 保证为正整数�?
 * 你可以认为输入字符串总是有效的；输入字符串中没有额外的空格，且输入的方括号�?�是符合格式要求的�??
 * 此外，你可以认为原始数据不包含数字，�?有的数字只表示重复的次数 k ，例如不会出现像 3a 或�?2[4] 的输入�??
 * @author Dreihunde
 *
 */
