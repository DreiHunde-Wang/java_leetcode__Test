...
/**
 * 给定�?个已按照 升序排列  的整数数组 numbers ，请你从数组中找出两个数满足相加之和等于目标数 target �?
 * 函数应该以长度为 2 的整数数组的形式返回这两个数的下标�?��?�numbers 的下�? �? 0 �?始计�? �?
 * �?以答案数组应当满�? 0 <= answer[0] < answer[1] < numbers.length �?
...
public class TwoPlusTarget {
	...
	//method 1 单指针移�?+二分查找 O(nlogn) O(1)
